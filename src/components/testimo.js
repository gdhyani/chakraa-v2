                ...
                <div className="sm:w-1/2">
                    ...
                    >
                        <SwiperSlide className=" rounded-3xl text-black ">
                            <div className="flex flex-row gap-2">
                                <div className=" overflow-hidden">
                                    <Image className="w-24 rounded-full overflow-hidden" src="/avatar1.jpg" width={400} height={400} alt="avatar"></Image>
                                </div>
                                <div className="">
                        ...
                        <SwiperSlide className=" rounded-3xl text-black ">
                            <div className="flex flex-row gap-2">
                            <div className=" overflow-hidden">
                                    <Image className="w-32 rounded-full overflow-hidden" src="/avatar2.jpg" width={400} height={400} alt="avatar"></Image>
                                </div>
                                <div className="">
                                    <h1 className="text-xl font-bold">John Doe</h1>
                                    <h1 className="text-md">Founder @Company</h1>
